...
export const ChainSelect = () => {
    ...
    return(
    <div style={{ "backdrop-filter": "blur(8px)" }} className={`w-[95%] z-10 bg-white backdrop-blur-lg bg-clip-padding bg-opacity-60 py-2 px-2 ml-auto mr-auto mt-6 lg:w-[80%] rounded-3xl ${ expand1 === true && 'h-auto'} ${expand1 === false && 'h-[100px]'}`}>
        ...
        <div onClick={ () => setExpand2(true)} className={`w-[97%] py-2 px-2 ${expand1 === false && 'hidden' } h-[230px]  mt-4 ml-auto mr-auto`}>
            ...
            <div className="w-[100%] h-36 mt-5 flex justify-items-center ml-auto mr-auto">
                <div className="w-[50%] py-2 px-2  ml-14 mr-auto ">
                    <p>Source Chain</p>
                    <select className="w-[80%] mt-3 h-[70px] ml-auto mr-auto items-center justify-center   rounded-md py-2 px-2 bg-slate-600" value={'chains'} />
                </div>
                <div className="w-[50%] py-2 px-2 ml-14 mr-auto ">
